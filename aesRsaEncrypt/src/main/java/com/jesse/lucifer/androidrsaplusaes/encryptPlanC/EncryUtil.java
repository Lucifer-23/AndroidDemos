...
public class EncryUtil {
    ...
    public static String encryptAes(Map<String, String> datas, String key, String iv) {
        String result = "";
        if (datas != null && !datas.isEmpty()) {
            String datasString = GsonTools.createGsonString(datas);
            result = AES.encryptToBase64(datasString, key, iv);
        }
        return result;
    }

    public static String encryptAes(String datas, String key, String iv) {
        String result = "";
        if (datas != null && !datas.isEmpty()) {
            result = AES.encryptToBase64(datas, key, iv);
        }
        return result;
    }

    public static String decryptAes(String datas, String key, String iv) {
        String result = "";
        if (!TextUtils.isEmpty(datas)) {
            result = AES.decryptFromBase64(datas, key, iv);
        }
        return result;
    }
}